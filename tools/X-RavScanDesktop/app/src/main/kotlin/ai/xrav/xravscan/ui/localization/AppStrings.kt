...
data class AppStrings(
    ...
    // Phase K — VLESS-suitability badge + log lines (SNI=b.cdn.net + WS Upgrade)
    val bunnyVlessBadge: String,
    val bunnyVlessAccept: (String, String, String) -> String,
    val bunnyVlessReject: (String, String) -> String,
    ...
    companion object {
        val EN = AppStrings(
            ...
            bunnyVlessBadge = "VLESS",
            bunnyVlessAccept = { ip, status, server -> "Bunny VLESS: $ip → $status (Server=$server) · accepted" },
            bunnyVlessReject = { ip, reason -> "Bunny VLESS: $ip discarded — $reason" },
        ...
        val RU = AppStrings(
            ...
            bunnyVlessBadge = "VLESS",
            bunnyVlessAccept = { ip, status, server -> "Bunny VLESS: $ip → $status (Server=$server) · принят" },
            bunnyVlessReject = { ip, reason -> "Bunny VLESS: $ip отброшен — $reason" },
