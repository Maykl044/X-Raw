...
class BunnyVlessProbe(
    ...
    fun probe(ip: String, port: Int = 443): Outcome {
        ...
        return runCatching {
            ...
            tls.use { socket ->
                ...
                if (peer == null) {
                    return Outcome(
                        accepted = false,
                        rttMs = System.currentTimeMillis() - started,
                        statusLine = null,
                        server = null,
                        tlsCommonName = null,
            ...
            log.debug("bunny vless probe {}:{} failed: {}: {}", ip, port, t.javaClass.simpleName, t.message)
            Outcome(
                accepted = false,
                rttMs = System.currentTimeMillis() - started,
                statusLine = null,
    ...
    companion object {
        ...
        private val log = LoggerFactory.getLogger(BunnyVlessProbe::class.java)
